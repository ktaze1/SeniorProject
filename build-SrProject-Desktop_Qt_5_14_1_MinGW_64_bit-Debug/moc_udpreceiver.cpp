...
#include <memory>
#include "../SrProject/udpreceiver.h"
...
QT_MOC_LITERAL(3, 32, 16) // "socketDescriptor"

    },
    "udpReceiver\0incomingConnection\0\0"
    "socketDescriptor"
};
...
void udpReceiver::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->incomingConnection((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
    }
}
